...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col max-w-3xl mx-auto h-full sm:px-0 px-4">
      <div className="flex-grow h-full overflow-auto">
        <div className="rounded-3xl relative overflow-y-auto text-darkText font-medium py-2 px-4">
          {prevMessage && sent && (
            <div>
              <div
          ...
          <div className="rounded-xl relative w-full">
            {chatRes ? (
              <div className="relative font-medium text-darkText">
                ...
                <div className="absolute -bottom-3 -right-1 flex items-center justify-between gap-2 text-darkText">
      ...
      <div className="sticky bottom-0 z-50">
        <div className="flex flex-col justify-center items-center bg-white">
          <div className="flex w-full items-center justify-center relative pt-4">
            <div className="w-full">
              <div
                ref={textInputBoxRef}
                contentEditable="true"
                className="w-full pl-6 pr-12 py-3 text-opacity-70 border-[1.5px] border-darkText border-dashed rounded-3xl !outline-none focus:outline-none whitespace-normal resize-y"
